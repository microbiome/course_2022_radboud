...
This course will focus on the \textbf{basics of microbiome data analysis
with R/Bioconductor}, a popular open source environment for
scientific data analysis. The participants get an overview of the
reproducible data analysis workflow in microbiome research, with a
focus on gut-brain axis. After the course you will know how to
approach new tasks in biomedical data analysis by utilizing available
...
The course will be organized in a live format (website)

\textbf{Venue} University of Radboud. July 11-15, 2022.

\textbf{Schedule} A
detailed schedule is available at the course website:
(\url{https://www.ru.nl/radboudsummerschool/courses/2022/registration-longer-possible-brain-bacteria}).
...
\tightlist
\item
  Source code (github): \href{https://github.com/microbiome/course_2022_radboud}{miaverse teaching material}
\item
  Course page (html): \href{https://microbiome.github.io/course_2022_radboud/}{miaverse teaching material}
\end{itemize}
...
coffee and lunch breaks. See \href{https://www.ru.nl/publish/pages/1026487/brain_bacteria_and_behaviour_-_understanding_the_gut-brain_axis-rss2022-v3.pdf}{Detailed program}.
