...
se <- readRDS("data/Tengeler2020/se.rds")
tse <- read_rds("data/Tengeler2020/tse.rds")
```

# Differential abundance analysis

Here, we analyse abundances with four different methods: 
**Aldex2**, **ANCOMBC**, **MaAsLin2** and **LinDA**. All of these
...
set and more explanations. Simultaneously, you may want to perform
...
Make sure you have installed the newest version of ANCOMBC by running the following line of code in case the code further below 
leads to an error.
